    ...
    <tr>
      <td style="width: 78%;">
        <table style="width: 100%;">
          <tr>
            <td style="width: 50%;">N° <span class="val-bold"><?= htmlspecialchars($code_paiement ?? $code_inscription ?? 'GE-25260178') ?></span></td>
  ...
  <table class="fin-table">
    ...
    <tbody>
      <tr>
        ...
        <td class="col-num"><?= isset($scolarite_op_du_jour) && $scolarite_op_du_jour > 0 ? number_format($scolarite_op_du_jour, 0, ',', ' ') . 'CFA' : '' ?></td>
      ...
      <tr>
        ...
        <td class="col-num"><?= number_format($versement_op_du_jour ?? $montant_operation ?? 0, 0, ',', ' ') ?>CFA</td>
        <td class="col-num"></td>
        <td class="col-num"></td>
        <td class="col-num"></td>
      </tr>
