        ...
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 14px;">
          <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div>
              ...
              <span style="font-size: 11.5px; color: #64748B;">Filtrer les affectations de cours par année</span>
            </div>
          </div>
...
$(document).ready(function() {
  ...
  $('#filter-annee').on('change', function() {
    var val = $(this).val();
    window.location.href = window.RACINE + 'enseignant_matiere/list?annee_code=' + encodeURIComponent(val);
  });
