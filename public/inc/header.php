...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= RACINE ?>public/assets/images/logo/logo_eicg.jpg">
    <link rel="apple-touch-icon" href="<?= RACINE ?>public/assets/images/logo/logo_eicg.jpg">
