...
class EnseignantController extends BaseController
{
    ...
    public function add()
    {
        ...
        $data['statut_enseignant'] = $data['statut_enseignant'] ?? 'actif';
        $data['created_at_enseignant'] = date('Y-m-d H:i:s');
    ...
    public function details($details)
    {
        ...
        $this->loadView('../views/enseignants/details.php', ['item' => $item, 'encryptedId' => $encryptedId]);
    }
    ...
    public function edition($details)
    {
        ...
        $this->loadView('../views/enseignants/edit.php', ['item' => $item, 'encryptedId' => $encryptedId]);
    }

    public function formulaire()
    {
        $this->requireAuth();
        $this->loadView('../views/enseignants/edit.php', ['item' => []]);
    }
}
